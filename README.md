...
- 🔎 **IP платы определяется сам** — управляемый ПК находит воткнутую в него
  ESP32 в локальной сети, вводить адрес вручную не нужно.
...
4. **На управляемом ПК:** включите «В сети» и продиктуйте код. Приложение
   **само найдёт плату ESP32** в сети — её IP появится в карточке. IP можно и
   вписать вручную, если хотите зафиксировать конкретный адрес.
